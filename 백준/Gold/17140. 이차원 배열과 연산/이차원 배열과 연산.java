...
//    private boolean isRowMany() {
//        int maxRow = 0, maxCol = 0;
//
//        for (int[] row : map) {
//            int nonZeroCnt = (int) Arrays.stream(row).filter(i -> i > 0).count();
//            if (nonZeroCnt > maxRow) maxRow = nonZeroCnt;
//        }
//
//        for (int j = 0; j < 100; j++) {
//            int nonZeroCnt = 0;
//            for (int i = 0; i < 100; i++) {
//                if (map[i][j] > 0) nonZeroCnt++;
//            }
//            if (nonZeroCnt > maxCol) maxCol = nonZeroCnt;
//        }
//
//        sout(new Object[] {maxRow, maxCol});
//
